...
const Dashboard = () => (
    <Admin authProvider={authProvider} theme={theme} dataProvider={simpleRestProvider('http://ubuntu@ec2-34-202-164-145.compute-1.amazonaws.com/api/backOffice', httpClient)}>
