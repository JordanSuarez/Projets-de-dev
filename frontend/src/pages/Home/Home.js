        ...
        <div className={classes.containerPresentation}>
          <div className={classes.presentation}>
            ...
            <p className={classes.descriptionSite}>
              L’idée a germé quand l’un d’entre nous s’est rendu compte qu’il n’était pas facile
              de partager nos projets et idées de projets avec d’autres personnes.
              Pour remédier à cette problématique, il a fallu trouver une solution : 
              une plateforme qui serait à la fois visuelle, pratique et qui permettrait à 
              n’importe quel développeur de partager ses idées et créations rapidement, 
              en quelques clics ! 
            </p>
          </div>
        </div>
